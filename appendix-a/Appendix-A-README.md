...
[my own ```json-pad``` GitHub Repository](https://github.com/tmarrs/json-pad) to preserve the codebase. My hope is to eventually re-platform this excellent tool on [NW.js - formerly known as Node Webkit](http://nwjs.io/) (rather than Adobe AIR) so that it will run as a cross-platform compatible GUI. But this effort will have to wait until the book is published.
