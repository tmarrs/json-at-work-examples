...
- The [AsciiDoc](http://asciidoc.org) version of Appendix A in the book was generated by [Pandoc](http://pandoc.org) from the original Markdown in the [_JSON at Work_ GitHub examples repository]
(https://github.com/tmarrs/json-at-work-examples/blob/master/appendix-a/README.md).
